...
APP_ID = 'app-monitor'
APP_TOKEN = '3a25af90-5238-4af0-b085-b7a7152b7b21'
# 蓝鲸智云开发者中心的域名，形如：http://openpaas.bk.com
BK_PAAS_HOST = "http://paas.blueking.evergrande.com"

AES_KEY = '12740f2c57aba727a4be179049cecf89'
# 是否启用统一权限
IS_USE_UAM_PERMISSION = False
CSRF_COOKIE_NAME = 'bklogin_csrftoken'
# Celery运行模式，True则为同步运行
...
MIDDLEWARE_CLASSES = (
    ...
    'common.middlewares.ExceptionHandlingMiddleware',  # 异常处理中间件
)
