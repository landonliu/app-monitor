...
def render_mako(template_name, dictionary={}, context_instance=None):
    ...
    resp = HttpResponse(mako_temp.render_unicode(**data))
    resp.set_cookie('csrftoken', context_instance['csrf_token'])
    # return response
...
def render_json(dictionary={}):
    ...
    #         'message': dictionary,
    #     }
    return HttpResponse(json.dumps(dictionary, cls=CJsonEncoder))  # , mimetype='application/json'
